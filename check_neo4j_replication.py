...
cmd_parser.add_option("-H", "--hosts", type="string", action = "store", dest = "hosts", help = "Hosts to query, comma separated", metavar = "Hosts")
cmd_parser.add_option("-p", "--port", type="string", action = "store", dest = "port", help = "JMX Port", metavar = "Port", default="3637")
cmd_parser.add_option("-w", "--warn", type="string", action = "store", dest = "warn", help = "Number of transactions behind to throw warning", metavar = "Integer")
cmd_parser.add_option("-c", "--critical", type="string", action = "store", dest = "critical", help = "Number of transactions behind to throw critical", metavar = "Integer")
